...
st.set_page_config(page_title="Image Processing App", page_icon="assets/logo%20pu.png")

st.sidebar.title("Navigation")
st.sidebar.write("Use the sidebar to navigate through the app.")

st.write("# Welcome to the Image Processing App")
st.image("assets/logo%20pu.png", width=200, caption="Our Beloved University")
